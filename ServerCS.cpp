...
int main(void)
{
	cout<< "The ServerCS is up and running using UDP on port 22001." << endl;
	int tryout = 0;
	...
	if ((rv = getaddrinfo(NULL, "22001", &hints, &servinfo)) != 0) {
	...
	pch = strtok(NULL,",");
	ctg = pch;
	cout << "The ServerCS received a request from the Main Server about the "<< ctg << " of "<< cs<< "."<<endl;
	int cateid;
